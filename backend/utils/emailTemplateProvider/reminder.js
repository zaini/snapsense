                        ...
                        <td
                            ...
                            <p style="font-size: 14px; line-height: 140%; text-align: center;"><span
                                style="font-size: 24px; line-height: 33.6px;"><strong><span
                                    style="line-height: 33.6px; font-size: 24px;">${obj.doctor} has requested you to make a submission.<br /></span></strong></span></p>
                            </div>
                    ...
                    <tbody>
                        ...
                        <td
                            ...
                            <p style="font-size: 14px; line-height: 170%; text-align: center;"><span
                                style="font-size: 16px; line-height: 27.2px;">${obj.doctor} would like you to send them a submission within ${obj.days} day(s).<br>
                                 This email is intended for ${obj.patient} (Patient).<br /></span></p>
